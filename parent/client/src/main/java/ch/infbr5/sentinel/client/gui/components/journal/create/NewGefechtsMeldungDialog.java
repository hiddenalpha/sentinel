...
public class NewGefechtsMeldungDialog extends JDialog implements ActionListener {
	...
	public NewGefechtsMeldungDialog(JFrame paranet) {
		super(paranet);
		setModal(true);
	...
	public void showDialog() {
		...
		add(SwingHelper.createLabel("Checkpoint"), "gap para");
		lblCheckpoint = SwingHelper.createLabel(checkpointName);
