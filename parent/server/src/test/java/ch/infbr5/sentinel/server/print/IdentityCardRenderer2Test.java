...
public class IdentityCardRenderer2Test {
	...
	public String createBarcode() {
		...
		String barcode = ObjectFactory.BARCODE_PREFIX.concat(String.valueOf(100000 + zufall.nextInt((int) Math.pow(10, ObjectFactory.BARCODE_LAENGE) - 100000)));
		return barcode;
	}
	...
	public void testCreate() throws IOException {
		...
		config.setDefaultWasserzeichen(to(IdentityCardRenderer2Test.class.getResource(ServerConfiguration.RESOURCE_PATH_AUSWEISVORLAGE_WASSERZEICHEN)));
		//config.setDefaultWasserzeichen(Files.toByteArray(new File(FileHelper.FILE_AUSWEISVORLAGE_WASSERZEICHEN)));

		IdendityCardRenderer r = new IdendityCardRenderer(ausweise, "infbr5", config);
		try {
