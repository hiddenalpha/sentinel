...
public class DataRowTest {
	...
	public void testCreatePersonDetails() {
		...
		Assert.assertEquals("11.02.1980", DateHelper.getFormatedString(details.getGeburtsdatum()));
	}
	
	@Test
	public void testGetGeburtstag() {
		Assert.assertEquals("11.02.1980", DateHelper.getFormatedString(testeeValid.getGeburtstag()));
	}
