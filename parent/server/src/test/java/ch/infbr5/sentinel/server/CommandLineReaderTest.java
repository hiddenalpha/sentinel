...
public class CommandLineReaderTest {
	...
	public void testDebugMode() {
		String args[] = {"-debug"};
		testee = new CommandLineReader(args, null, "8080", false);
		Assert.assertTrue(testee.isDebugMode());

		String args2[] = {};
		testee = new CommandLineReader(args2, null, "8080", false);
